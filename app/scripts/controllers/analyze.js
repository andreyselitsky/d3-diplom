...
angular.module('d3DiplomApp')
    .controller('AnalyzeCtrl', function ($scope) {
        $scope.regions = localStorage.getItem('graphs') ? JSON.parse(localStorage.getItem('graphs')) : [];
        $scope.investors = localStorage.getItem('investors') ? JSON.parse(localStorage.getItem('investors')) : [];
